...
<body>
  <div data-target="readme-toc.content" class="Box-body px-5 pb-5">
    ...
    <div class="highlight highlight-text-html-basic position-relative overflow-auto" data-snippet-clipboard-copy-content="  <script src=&quot;https://cdn.jsdelivr.net/npm/dynamsoft-camera-enhancer@2.1.0/dist/dce.js&quot;></script>"><pre>  <span class="pl-kos">&lt;</span><span class="pl-ent">script</span> <span class="pl-c1">src</span>="<span class="pl-s">https://cdn.jsdelivr.net/npm/dynamsoft-camera-enhancer@2.1.0/dist/dce.js</span>"<span class="pl-kos">&gt;</span><span class="pl-kos">&lt;/</span><span class="pl-ent">script</span><span class="pl-kos">&gt;</span></pre></div>
    <ul dir="auto">
    <li>UNPKG</li>
    </ul>
    <div class="highlight highlight-text-html-basic position-relative overflow-auto" data-snippet-clipboard-copy-content="  <script src=&quot;https://unpkg.com/dynamsoft-camera-enhancer@2.1.0/dist/dce.js&quot;></script>"><pre>  <span class="pl-kos">&lt;</span><span class="pl-ent">script</span> <span class="pl-c1">src</span>="<span class="pl-s">https://unpkg.com/dynamsoft-camera-enhancer@2.1.0/dist/dce.js</span>"<span class="pl-kos">&gt;</span><span class="pl-kos">&lt;/</span><span class="pl-ent">script</span><span class="pl-kos">&gt;</span></pre></div>
    ...
    <div class="highlight highlight-source-batchfile position-relative overflow-auto" data-snippet-clipboard-copy-content="$ yarn add dynamsoft-camera-enhancer"><pre>$ yarn add dynamsoft-camera-enhancer</pre></div>
    <ul dir="auto">
    <li>npm</li>
    </ul>
    <div class="snippet-clipboard-content position-relative overflow-auto" data-snippet-clipboard-copy-content="$ npm install dynamsoft-camera-enhancer --save"><pre><code>$ npm install dynamsoft-camera-enhancer --save
    </code></pre></div>
    <p dir="auto">Depending on how you downloaded the library and where you put it. You can typically include it like this:</p>
    <div class="highlight highlight-text-html-basic position-relative overflow-auto" data-snippet-clipboard-copy-content="<script src=&quot;/DCE-JS-2.1.0/dist/dce.js&quot;></script>
    
    or
    
    ```html
    <script src=&quot;/node_modules/dynamsoft-camera-enhancer/dist/dce.js&quot;></script>"><pre><span class="pl-kos">&lt;</span><span class="pl-ent">script</span> <span class="pl-c1">src</span>="<span class="pl-s">/DCE-JS-2.1.0/dist/dce.js</span>"<span class="pl-kos">&gt;</span><span class="pl-kos">&lt;/</span><span class="pl-ent">script</span><span class="pl-kos">&gt;</span>
    
    or
    
    ```html
    <span class="pl-kos">&lt;</span><span class="pl-ent">script</span> <span class="pl-c1">src</span>="<span class="pl-s">/node_modules/dynamsoft-camera-enhancer/dist/dce.js</span>"<span class="pl-kos">&gt;</span><span class="pl-kos">&lt;/</span><span class="pl-ent">script</span><span class="pl-kos">&gt;</span></pre></div>
    ...
    <div class="highlight highlight-source-js position-relative overflow-auto" data-snippet-clipboard-copy-content="let enhancer = await Dynamsoft.DCE.CameraEnhancer.createInstance();"><pre><span class="pl-k">let</span> <span class="pl-s1">enhancer</span> <span class="pl-c1">=</span> <span class="pl-k">await</span> <span class="pl-v">Dynamsoft</span><span class="pl-kos">.</span><span class="pl-c1">DCE</span><span class="pl-kos">.</span><span class="pl-c1">CameraEnhancer</span><span class="pl-kos">.</span><span class="pl-en">createInstance</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-kos">;</span></pre></div>
    ...
    <div class="highlight highlight-text-html-basic position-relative overflow-auto" data-snippet-clipboard-copy-content="<!-- Define an element to hold the UI element -->
    <div id=&quot;enhancerUIContainer&quot;></div>
    <script>
        let enhancer = await Dynamsoft.DCE.CameraEnhancer.createInstance();
        document.getElementById(&quot;enhancerUIContainer&quot;).appendChild(enhancer.getUIElement());
        await enhancer.open(true);
    </script>"><pre><span class="pl-c">&lt;!-- Define an element to hold the UI element --&gt;</span>
    ...
    <div class="highlight highlight-source-js position-relative overflow-auto" data-snippet-clipboard-copy-content="Dynamsoft.DCE.CameraEnhancer.defaultUIElementURL = &quot;THE-URL-TO-THE-FILE&quot;;"><pre><span class="pl-v">Dynamsoft</span><span class="pl-kos">.</span><span class="pl-c1">DCE</span><span class="pl-kos">.</span><span class="pl-c1">CameraEnhancer</span><span class="pl-kos">.</span><span class="pl-c1">defaultUIElementURL</span> <span class="pl-c1">=</span> <span class="pl-s">"THE-URL-TO-THE-FILE"</span><span class="pl-kos">;</span></pre></div>
    <blockquote>
    ...
    <div class="highlight highlight-text-html-basic position-relative overflow-auto" data-snippet-clipboard-copy-content="<div id=&quot;enhancerUIContainer&quot;></div>
    <script>
        document.getElementById('enhancerUIContainer').appendChild(enhancer.getUIElement());
    </script>"><pre><span class="pl-kos">&lt;</span><span class="pl-ent">div</span> <span class="pl-c1">id</span>="<span class="pl-s">enhancerUIContainer</span>"<span class="pl-kos">&gt;</span><span class="pl-kos">&lt;/</span><span class="pl-ent">div</span><span class="pl-kos">&gt;</span>
    <span class="pl-kos">&lt;</span><span class="pl-ent">script</span><span class="pl-kos">&gt;</span>
        <span class="pl-smi">document</span><span class="pl-kos">.</span><span class="pl-en">getElementById</span><span class="pl-kos">(</span><span class="pl-s">'enhancerUIContainer'</span><span class="pl-kos">)</span><span class="pl-kos">.</span><span class="pl-en">appendChild</span><span class="pl-kos">(</span><span class="pl-s1">enhancer</span><span class="pl-kos">.</span><span class="pl-en">getUIElement</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-kos">)</span><span class="pl-kos">;</span>
    <span class="pl-kos">&lt;/</span><span class="pl-ent">script</span><span class="pl-kos">&gt;</span></pre></div>
    <ul dir="auto">
    ...
    <div class="highlight highlight-text-html-basic position-relative overflow-auto" data-snippet-clipboard-copy-content="<div id=&quot;div-video-container&quot;>
    ...
    </script>"><pre><span class="pl-kos">&lt;</span><span class="pl-ent">div</span> <span class="pl-c1">id</span>="<span class="pl-s">div-video-container</span>"<span class="pl-kos">&gt;</span>
        <span class="pl-kos">&lt;</span><span class="pl-ent">video</span> <span class="pl-c1">class</span>="<span class="pl-s">dce-video</span>" <span class="pl-c1">playsinline</span>="<span class="pl-s">true</span>" <span class="pl-c1">muted</span> <span class="pl-c1">style</span>="<span class="pl-s">width:100%;height:100%;position:absolute;left:0;top:0;</span>"<span class="pl-kos">&gt;</span><span class="pl-kos">&lt;/</span><span class="pl-ent">video</span><span class="pl-kos">&gt;</span>
    ...
    <span class="pl-kos">&lt;/</span><span class="pl-ent">script</span><span class="pl-kos">&gt;</span></pre></div>
    <blockquote>
    <p dir="auto">The video element must have the class <code>dce-video</code> .</p>
    </blockquote>
    <ul dir="auto">
    ...
    <div class="highlight highlight-text-html-basic position-relative overflow-auto" data-snippet-clipboard-copy-content="<select class=&quot;dce-sel-camera&quot;></select>"><pre><span class="pl-kos">&lt;</span><span class="pl-ent">select</span> <span class="pl-c1">class</span>="<span class="pl-s">dce-sel-camera</span>"<span class="pl-kos">&gt;</span><span class="pl-kos">&lt;/</span><span class="pl-ent">select</span><span class="pl-kos">&gt;</span></pre></div>
    <div class="highlight highlight-text-html-basic position-relative overflow-auto" data-snippet-clipboard-copy-content="<select class=&quot;dce-sel-resolution&quot;></select>"><pre><span class="pl-kos">&lt;</span><span class="pl-ent">select</span> <span class="pl-c1">class</span>="<span class="pl-s">dce-sel-resolution</span>"<span class="pl-kos">&gt;</span><span class="pl-kos">&lt;/</span><span class="pl-ent">select</span><span class="pl-kos">&gt;</span></pre></div>
    <blockquote>
    ...
    <div class="highlight highlight-text-html-basic position-relative overflow-auto" data-snippet-clipboard-copy-content="<select class=&quot;dce-sel-resolution&quot;>
        <option class=&quot;dce-opt-gotResolution&quot; value=&quot;got&quot;></option>
        <option data-width=&quot;1280&quot; data-height=&quot;720&quot;>1280 x 720</option>
        <option data-width=&quot;800&quot; data-height=&quot;600&quot;>800 x 600</option>
        <option data-width=&quot;640&quot; data-height=&quot;480&quot;>640 x 480</option>
    </select>"><pre><span class="pl-kos">&lt;</span><span class="pl-ent">select</span> <span class="pl-c1">class</span>="<span class="pl-s">dce-sel-resolution</span>"<span class="pl-kos">&gt;</span>
    ...
    <blockquote>
    <p dir="auto">Generally, you need to provide a resolution that the camera supports. However, in case a camera does not support the specified resolution, it usually uses the cloest supported resolution. As a result, the selected resolution may not be the actual resolution. In this case, add an option with the class name <code>dce-opt-gotResolution</code> (as shown above) and the library will then use it to show the actual resolution.</p>
    </blockquote>
    ...
    <div class="highlight highlight-text-html-basic position-relative overflow-auto" data-snippet-clipboard-copy-content="<script src=&quot;https://www.yourwebsite.com/dynamsoft-camera-enhancer/dist/dce.js&quot;></script>"><pre><span class="pl-kos">&lt;</span><span class="pl-ent">script</span> <span class="pl-c1">src</span>="<span class="pl-s">https://www.yourwebsite.com/dynamsoft-camera-enhancer/dist/dce.js</span>"<span class="pl-kos">&gt;</span><span class="pl-kos">&lt;/</span><span class="pl-ent">script</span><span class="pl-kos">&gt;</span></pre></div>
