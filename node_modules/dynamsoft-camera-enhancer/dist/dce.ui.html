<div style="width:100%;height:100%;min-width:100px;min-height:100px;background:#ddd;position:relative;">
	...
	<div class="dce-scanarea" style="width:100%;height:100%;position:absolute;left:0;top:0;">
		...
		<div class="dce-scanlight" style="display:none;width:100%;height:3%;position:absolute;animation:3s infinite dce-scanlight;border-radius:50%;box-shadow:0px 0px 2vw 1px #00e5ff;background:#fff;user-select:none;"></div>
	</div>
	...
	<div class="dce-msg-poweredby" style="position:absolute;left:50%;bottom:10%;transform:translateX(-50%);">
